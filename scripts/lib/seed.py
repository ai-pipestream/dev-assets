...
def _write_default_env(env_file: Path, ws: Workspace, dry_run: bool) -> None:
    ...
    (jdbc-connector and s3-connector live under <root>/<tree>/connectors/
    instead of under core-services).
    """
    core = ws.root / ws.tree / "core-services"
    modules = ws.root / ws.tree / "modules"
    connectors = ws.root / ws.tree / "connectors"
